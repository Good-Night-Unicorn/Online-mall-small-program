<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商品质量" prop="shangpinzhiliang">
          <el-select v-model="ruleForm.shangpinzhiliang" placeholder="请选择商品质量">
            <el-option
                v-for="(item,index) in shangpinzhiliangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="商品质量" prop="shangpinzhiliang">
	      <el-input v-model="ruleForm.shangpinzhiliang"
                placeholder="商品质量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="服务态度" prop="fuwutaidu">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinmingcheng = true;
          ...
          if(o=='shangpinzhiliang'){
            this.ruleForm.shangpinzhiliang = obj[o];
	    this.ro.shangpinzhiliang = true;
            continue;
          }
          if(o=='fuwutaidu'){
      ...
      this.$http({
		...
		if(json.zhaopian!=''&&json.zhaopian){
          ...
          this.$message.error(data.msg);
            ...
            this.shangpinzhiliangOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
	...
	this.ruleForm.pingyu = this.ruleForm.pingyu.replace(reg,'../../../ssm913sv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
